...
const jobsData: CreateJobDto[] = [
  ...
  },
  {
    ...
    type: 'Part-Time',
    location: 'Pariatur Ullam dolo',
    description: 'Vel repudiandae in i',
    salary: 'Under $50K',
    company: {
      name: 'Dudley and Randolph Co',
      description: 'Magna voluptas dolor',
      contactEmail: 'xinizyq@mailinator.com',
      contactPhone: '+1 (468) 549-6371',
    },
  },
];
